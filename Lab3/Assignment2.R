...
# Once a SVM has been fitted to the training data, a new point is essentially classified according 
# to the sign of a linear combination of the kernel function values between the support vectors and 
# the new point. You are asked to implement this linear combination for filter3. You should make use of 
# the functions alphaindex, coef and b that return the indexes of the support vectors, the linear 
# coefficients for the support vectors, and the negative intercept of the linear combination. 
# See the help file of the kernlab package for more information. You can check if your results 
# are correct by comparing them with the output of the function predict where you set type = "decision". 
# Do so for the first 10 points in the spam dataset. Feel free to use the template provided in the 
# Lab3Block1 2021 SVMs St.R file
